...
vlog -work xilinx_vip -64 -incr -sv -L smartconnect_v1_0 "+incdir+/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr -sv -L smartconnect_v1_0 "+incdir+../../../../Aloha-HE_Kintex.srcs/sources_1/bd/ComputeCoreWrapper_test/ipshared/c923" "+incdir+/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr "+incdir+../../../../Aloha-HE_Kintex.srcs/sources_1/bd/ComputeCoreWrapper_test/ipshared/c923" "+incdir+/tools/Xilinx/Vivado/2019.1/data/xilinx_vip/include" \
