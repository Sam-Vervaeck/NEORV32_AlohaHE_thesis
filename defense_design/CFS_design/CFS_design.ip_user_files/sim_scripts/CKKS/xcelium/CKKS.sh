...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.CKKS \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../CFS_design.srcs/sources_1/bd/CKKS/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../CFS_design.srcs/sources_1/bd/CKKS/ipshared/c923" \
       +incdir+"$ref_dir/../../../bd/CKKS/ipshared/ca68/src" \
       +incdir+"../../../../CFS_design.srcs/sources_1/bd/CKKS/ipshared/ec67/hdl" \
       +incdir+"../../../../CFS_design.srcs/sources_1/bd/CKKS/ipshared/c923" \
       +incdir+"../../../../CFS_design.srcs/sources_1/bd/CKKS/ipshared/ca68/src"
}
