...
HD_PWD='/home/sam/Documents/thesis-defense/defense_design/CFS_design/CFS_design.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log CKKS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CKKS_wrapper.tcl -notrace
