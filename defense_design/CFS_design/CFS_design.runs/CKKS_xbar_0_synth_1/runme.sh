...
HD_PWD='/home/sam/Documents/thesis-defense/defense_design/CFS_design/CFS_design.runs/CKKS_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CKKS_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CKKS_xbar_0.tcl
