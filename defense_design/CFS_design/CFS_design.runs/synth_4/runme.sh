...
HD_PWD='/home/sam/Documents/thesis-defense/defense_design/CFS_design/CFS_design.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log CKKS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CKKS_wrapper.tcl
