...
HD_PWD='/home/sam/Documents/thesis-defense/defense_design/CFS_design/CFS_design.runs/CKKS_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CKKS_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CKKS_clk_wiz_0_0.tcl
